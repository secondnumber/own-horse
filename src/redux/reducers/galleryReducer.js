...
let initialState = {
  ...
  galleryImages: [
    { id: 1, imgSmall: ImgSmall1, imgBig: ImgBig1 },
    { id: 2, imgSmall: ImgSmall2, imgBig: ImgBig1 },
    { id: 3, imgSmall: ImgSmall3, imgBig: ImgBig1 },
    { id: 4, imgSmall: ImgSmall4, imgBig: ImgBig1 },
    { id: 5, imgSmall: ImgSmall5, imgBig: ImgBig1 },
    { id: 6, imgSmall: ImgSmall6, imgBig: ImgBig1 },
    { id: 7, imgSmall: ImgSmall7, imgBig: ImgBig1 },
    { id: 8, imgSmall: ImgSmall8, imgBig: ImgBig1 },
    { id: 9, imgSmall: ImgSmall9, imgBig: ImgBig1 },
    { id: 10, imgSmall: ImgSmall10, imgBig: ImgBig1 },
    { id: 11, imgSmall: ImgSmall11, imgBig: ImgBig1 },
    { id: 12, imgSmall: ImgSmall12, imgBig: ImgBig1 },
  ],
};
