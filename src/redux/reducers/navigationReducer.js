  ...
  navMenuItems: [
    { id: 1, menuItem: 'Homepage', menuLink: '/' },
    {
      ...
      nestedMenu: [
        ...
        { id: 4, nestedMenuItem: 'Pricing plans', nestedMenuLink: '/pages/price' },
        { id: 5, nestedMenuItem: 'Testimonials', nestedMenuLink: '/pages/testimonials' },
        { id: 6, nestedMenuItem: 'Statistic', nestedMenuLink: '/pages/statistic' },
      ],
    },
